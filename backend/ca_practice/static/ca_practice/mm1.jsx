...
function App() {
  const defaults =
    (typeof window !== "undefined" && window.GRAPH_DEFAULTS_MM1) || {};
  ...
  let bigBoxZ = null;
  if (zSize) {
    const paddingLeft = 100; // left padding
    const paddingRight = 100; // right padding
...
ReactDOM.createRoot(document.getElementById("root_mm1")).render(<App />);
