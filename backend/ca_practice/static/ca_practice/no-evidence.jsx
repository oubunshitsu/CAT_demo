...
function App() {
  const defaults =
    (typeof window !== "undefined" && window.GRAPH_DEFAULTS_NO_EVIDENCE) || {};
  ...
  if (zSize) {
    ...
    const paddingRight = 150; // right padding
  ...
  if (zToYArrow && xToYArrow && bigBoxZ) {
    ...
    const arrowTipOffset = 20; // negative raises tip (shorter), positive lowers (longer)
...
ReactDOM.createRoot(document.getElementById("root_no_evidence")).render(<App />);
