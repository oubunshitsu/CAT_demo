...
class Command(BaseCommand):
    help = "Export main-app tables to CSV files."

    def add_arguments(self, parser):
        parser.add_argument(
            "--out-dir",
            default="exports/ca_practice",
        ...
        parser.add_argument(
            ...
            choices=["app", "all"],
            default="app",
            help="app=main app tables (+auth user), all=all managed models.",
        )
    ...
    def handle(self, *args, **options):
        ...
        for model in all_models:
            ...
            if not meta.managed or meta.proxy or meta.swapped:
                continue
            if scope == "app" and meta.app_label != "ca_practice":
                continue
            tables.append(model)
